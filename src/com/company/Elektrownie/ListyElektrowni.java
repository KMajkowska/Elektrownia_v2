    ...
    public ArrayList<Elektrownia> elektrownie = new ArrayList<>() {
        {
            ...
            add(new ElektrowniaAtomowa("Belleville", "Burgundia",2010, 1500, 10, 10, wlasciciele.getWlasciciele().get(0), false, 1, 10f, dystrybutorzy.getDystrybutorzyPradu().get(4), 2, 150, dostawcy.odbiocyOdpadow.get(4), 900000, 450000, 150000, 10));
